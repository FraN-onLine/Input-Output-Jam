...
var portrait = preload("res://Assets/Characters/IO-Student_NonGlossed.png")
...
# ── Day 2 ─────────────────────────────────────────────────────────────────────
# Branching opener: if Good_Points >= 2 the student is grateful (entries 0-6).
# If Good_Points < 2, they're more desperate and direct (entries 7-12).
var day2 = [
	{
		# Branching entry — auto-resolves based on Good_Points
		"name": "Student",
		"portrait": portrait,
		"text": "Hey Mr. Vending Machine! It's me again...",
		"type": "branching",
		"branch_min_points": 2,
		"branch_success_entry_index": 1,   # Good_Points >= 2: grateful path
		"branch_failure_entry_index": 7    # Good_Points < 2: desperate path
	},
	# ── Grateful path (Good_Points >= 2) ──
	{
		"name": "Student",
		"portrait": portrait,
	...
	# ── Common exit ──
	{
		...
		"type": "end_of_day",
		"day_number": 2,
		"next_day_dialogue_index": -1  # -1 = no more days, game ends
	}
]